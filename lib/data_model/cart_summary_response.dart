...
//
// TempCartSummaryResponse tempCartSummaryResponseFromJson(String str) => TempCartSummaryResponse.fromJson(json.decode(str));
//
// String tempCartSummaryResponseToJson(TempCartSummaryResponse data) => json.encode(data.toJson());
//
// class TempCartSummaryResponse {
//   TempCartSummaryResponse({
//     this.sub_total,
//     this.tax,
//     this.shipping_cost,
//     this.discount,
...
//   bool coupon_applied;
//
//   factory TempCartSummaryResponse.fromJson(Map<String, dynamic> json) =>
//       TempCartSummaryResponse(
//         sub_total: json["sub_total"],
//         tax: json["tax"],
//         shipping_cost: json["shipping_cost"],
